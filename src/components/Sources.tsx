...
const sources = [
  ...
  { name: "Reddit", icon: RedditIcon, color: "text-[#FF4500]" },
  { name: "YouTube", icon: YouTubeIcon, color: "text-[#FF0000]" },
  { name: "Instagram", icon: InstagramIcon, color: "text-[#E4405F]" },
  { name: "News", icon: NewsIcon, color: "text-[var(--color-amber)]" },
  { name: "Blogs", icon: BlogIcon, color: "text-[var(--color-accent)]" },
];

export default function Sources() {
  return (
    <section className="px-6 md:px-12 py-10 max-w-4xl mx-auto border-y border-[var(--color-border-subtle)]">
      <FadeIn>
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
          ...
          {sources.map((source) => (
            <span
              key={source.name}
              className={`flex items-center gap-2 ${source.color}`}
            >
              <source.icon />
